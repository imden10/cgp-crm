                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{route('clients.create')}}" class="btn btn-block btn-success btn-xs">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right" style="width: 210px">
                                            <form action="{{ route('clients.destroy', $item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <a class="btn btn-primary btn-xs" href="{{route('clients.show', $item->id)}}">
                                                    <i class="fas fa-folder">
                                                    </i>
                                                    View
                                                </a>
                                                <a class="btn btn-info btn-xs" href="{{route('clients.edit', $item->id)}}">
